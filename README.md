...
Learn more about PyCharge in our research paper published in [Computational Physics Communications](https://doi.org/10.1016/j.cpc.2022.108291) and includes an extensive review of the rich physics that govern mechanically dressed dipole-dipole interactions with electromagnetically coupled oscillating dipoles on [Physics Review A](https://journals.aps.org/pra/abstract/10.1103/bmm8-9pn6).
...
<p align="center">
  <img width="600" src="PyCharge Overview Shema.png">
</p>
